...
function buildInfoTabProps(params: BuildAdminUserDetailContentPropsParams): InfoTabContentProps {
  const {
    user,
    actionLoading,
    formatDate,
...
function buildSubscriptionTabProps(
...
function buildSyncTabProps(params: BuildAdminUserDetailContentPropsParams): SyncTabContentProps {
  const { syncStatus, userRemnawaveUuid, locale, actionLoading, onSyncFromPanel, onSyncToPanel } =
    params;
...
export function buildAdminUserDetailContentProps(
  params: BuildAdminUserDetailContentPropsParams,
): AdminUserDetailTabProps {
  return {
    infoTab: buildInfoTabProps(params),
    subscriptionTab: buildSubscriptionTabProps(params),
    balanceTab: buildBalanceTabProps(params),
    syncTab: buildSyncTabProps(params),
    ticketsTab: buildTicketsTabProps(params),
  };
}
