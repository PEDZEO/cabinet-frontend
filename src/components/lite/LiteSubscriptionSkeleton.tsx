  ...
  return (
    <div className="mx-auto max-w-md animate-pulse px-4 py-6">
      ...
      <div className="mb-6 flex gap-2">
        <div className="h-10 flex-1 rounded-xl border border-dark-600 bg-dark-700" />
        <div className="h-10 flex-1 rounded-xl border border-dark-700 bg-dark-800/50" />
        <div className="h-10 flex-1 rounded-xl border border-dark-700 bg-dark-800/50" />
      </div>
      ...
      <div className="space-y-4">
        {[1, 2, 3].map((i) => (
          <div key={i} className="rounded-2xl border border-dark-700/90 bg-dark-800/55 p-4">
      ...
      <div className="mt-6 h-12 w-full rounded-xl border border-dark-700/80 bg-dark-800/55" />

      {/* Promo code skeleton */}
      <div className="mt-4 flex gap-2">
        <div className="h-12 flex-1 rounded-xl border border-dark-700/80 bg-dark-800/55" />
        <div className="h-12 w-24 rounded-xl border border-dark-600 bg-dark-700" />
      </div>
    </div>
  );
}
