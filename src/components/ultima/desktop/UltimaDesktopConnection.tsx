                  ...
                  <div className="flex items-center justify-center">
                    <div className="relative flex h-[260px] w-[260px] items-center justify-center">
                      <div
                        ...
                        style={{
                          borderColor:
                            'color-mix(in srgb, var(--ultima-color-ring) 22%, transparent)',
                        }}
                      />
                      <div
                        ...
                        style={{
                          borderColor:
                            'color-mix(in srgb, var(--ultima-color-ring) 18%, transparent)',
                        }}
                      />
                      <div
                        ...
                        style={{
                          borderColor:
                            'color-mix(in srgb, var(--ultima-color-ring) 46%, transparent)',
                        }}
                      />
                      <svg
                        viewBox="0 0 240 240"
                  ...
                  {stepCards.map((card) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="mt-2 text-sm leading-[1.55] text-white/[0.66]">
                          {card.subtitle}
                        </p>
                      </div>
                    );
