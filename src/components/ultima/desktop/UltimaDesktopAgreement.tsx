      ...
      <div className="ultima-desktop-stage">
        ...
        <div className="ultima-desktop-stage-body has-context">
          <aside className="ultima-desktop-context">
            ...
            >
              <div className="flex h-11 w-11 items-center justify-center rounded-[16px] border border-white/10 bg-white/[0.07] text-white/[0.84]">
                <DocumentIcon />
              </div>
              ...
              <div className="mt-6 rounded-[18px] border border-white/10 bg-black/[0.15] px-4 py-3">
                <div className="text-[11px] uppercase tracking-[0.22em] text-white/[0.42]">
                  {t('common.lastUpdated', { defaultValue: 'Последнее обновление' })}
                </div>
                <div className="mt-2 text-sm font-medium text-white/[0.88]">
          ...
          <section
            className={cn(
              ultimaCardClassName,
              'ultima-desktop-main flex min-h-[calc(100dvh-128px)] flex-col overflow-hidden p-0',
            )}
          ...
          >
            <div className="flex items-center justify-between border-b border-white/[0.08] px-6 py-5">
              ...
              <div className="text-sm text-white/[0.52]">
                {updatedAtLabel ??
                  t('common.currentVersion', { defaultValue: 'Актуальная версия' })}
              </div>
            </div>
